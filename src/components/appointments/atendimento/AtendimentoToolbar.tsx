      ...
      <div className="call-controls">
        ...
        {role === 'medico' && (
          <button 
            ...
            aria-label={isRecording ? 'Parar Transcrição' : 'Iniciar Transcrição'}
            title={isRecording ? 'Parar gravação e gerar resumo' : 'Gravar conversa para resumo automático'}
          >
            {isProcessingAudio ? (
              <div className="spinner-small" />
            ) : isRecording ? (
              <svg viewBox="0 0 24 24" fill="var(--color-danger-500)"><rect x="6" y="6" width="12" height="12" rx="2" /></svg>
            ) : (
              <svg viewBox="0 0 24 24"><path d="M12 2a3 3 0 0 0-3 3v7a3 3 0 0 0 6 0V5a3 3 0 0 0-3-3Z" /><path d="M19 10v2a7 7 0 0 1-14 0v-2" /><line x1="12" x2="12" y1="19" y2="22" /></svg>
            )}
          </button>

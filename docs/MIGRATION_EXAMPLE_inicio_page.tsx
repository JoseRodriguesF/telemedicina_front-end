/**
 * EXEMPLO DE MIGRAÇÃO: app/inicio/page.tsx
 * 
 * Este arquivo demonstra como migrar a página de início para usar os hooks otimizados.
 * 
 * ANTES vs DEPOIS:
 * - Antes: 3 useEffect separados, chamadas manuais, sem cache
 * - Depois: Hooks otimizados com SWR, cache automático, polling inteligente
 */
...
import { cancelarConsulta, ConsultaAgendada } from '@/lib/axios/consultas';

export default function InicioPageOptimized() {
    ...
    // ✅ OTIMIZADO: Loading consolidado
    const isLoading = loadingConsultas || loadingHistorico;
